                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('name', $permission->name) }}"
                                        class="form-control @error('name') is-invalid @enderror" autocomplete="off" readonly
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('display_name', $permission->display_name) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{ old('description', $permission->description) }}"
