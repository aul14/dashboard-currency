                ...
                <div class="card-header pb-1">
                    <div class="d-flex align-items-center">
                        @permission('create-permission')
                            <a href="{{ route('permissions.create') }}" class="btn btn-sm btn-primary mb-2">Add</a>
                        @endpermission()
                    </div>
                </div>
                        ...
                        <table id="myTable" class="my-table1 table my-tableview my-table-striped table-hover w-100">
                            <thead>
                                <tr>
                                    <th>Action</th>
                                    <th>No</th>
                                    <th class="select-filter">Module Name</th>
                                    <th class="select-filter">Key Permission</th>
                                    <th class="select-filter">Display</th>
